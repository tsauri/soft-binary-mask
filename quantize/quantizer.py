...
from quantize.fixed_point import quantize_fixed_point
from quantize.linear import quantize_linear, quantize_linear_fix_zeros
from quantize.kmeans import quantize_k_means, quantize_k_means_fix_zeros
